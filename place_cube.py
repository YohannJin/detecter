...
class graspAruco:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/aruco_sink1", Pose, self.sinkCallback, queue_size = 1)
        self.image_sub = rospy.Subscriber("/aruco_sink2", Pose, self.sinkCallback, queue_size = 1)
        self.image_sub = rospy.Subscriber("/aruco_sink3", Pose, self.sinkCallback, queue_size = 1)

        #flag to show if proceed success
    ...
    def sinkCallback1(self,data):
        ...
        if (distance_in_x <= gama_x) and (distance_in_y <= gama_y):
            ...
            #self.move_base_velocity_x(b_vector=0.5, duration=16)
